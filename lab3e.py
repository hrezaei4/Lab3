#!/usr/bin/env python3
'''Lab 3 - Functions with List Indexing'''
# Author ID: hrezaei4
...
if __name__ == '__main__':
    print(give_list())                    # Should print [100, 200, 300, 'six hundred']
    print(give_first_item())              # Should print 100
    print(give_first_and_last_item())     # Should print [100, 'six hundred']
    print(give_second_and_third_item())   # Should print [200, 300]
